...
def build_nn(observation_space):
    ...
    motors = Dense(units=64, activation="tanh")(x)
    tilt = Dense(units=64, activation="tanh")(x)

    policy1 = Dense(units=6, activation="softmax")(motors)
    policy2 = Dense(units=6, activation="softmax")(motors)
    policy3 = Dense(units=6, activation="softmax")(motors)
    policy4 = Dense(units=6, activation="softmax")(motors)
