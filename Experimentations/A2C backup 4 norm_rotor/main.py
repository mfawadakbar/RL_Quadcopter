...
def act(
    ...
    action0 = np.random.choice(6, p=np.squeeze(action_probs[0]))
    action1 = np.random.choice(6, p=np.squeeze(action_probs[1]))
    action2 = np.random.choice(6, p=np.squeeze(action_probs[2]))
    action3 = np.random.choice(6, p=np.squeeze(action_probs[3]))
