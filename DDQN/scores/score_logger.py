...
SCORES_CSV_PATH = f"{LOCAL_PATH}/scores.csv"
SCORES_PNG_PATH = f"{LOCAL_PATH}/scores.png"
SOLVED_CSV_PATH = f"{LOCAL_PATH}/solved.csv"
SOLVED_PNG_PATH = f"{LOCAL_PATH}/solved.png"
AVERAGE_SCORE_TO_SOLVE = 950
